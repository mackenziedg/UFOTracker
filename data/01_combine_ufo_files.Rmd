---
title: "Process historical entity level data"
...
Step 1: Capture a list of all files for SY1415 and SY1516
```{r}


#list.files(my.directory, pattern = "*.csv", full.names = TRUE)
#files <- list.files("../../../Source/PARCC Comps/", pattern="*.xlsx", full.names=TRUE) 
#files
```

Step 2: Read in files and combine
```{r}

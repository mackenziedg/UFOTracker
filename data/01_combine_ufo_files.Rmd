...
all.states.normalized.df <- sightings.db2 %>% 
    ...
    select(one_of("year", "region", "sightings_per_100k", "alienmovies_per_year", "per_capita_gdp_current", "internet_avg", "internet_urban", "internet_suburban", "internet_rural", "normalized_afb_count"))
...
```{r}
write_csv(statepops.db3, "clean/statepops.db3.csv")
```
